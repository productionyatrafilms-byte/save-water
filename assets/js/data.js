...
const topicPoints = {
  ...
  2: [
    ...
    { id: 6, english: "Use less water while washing hands.", hindi: "हाथ धोते समय कम पानी इस्तेमाल करें।", guj: "હાથ ધોતી વખતે ઓછું પાણી વાપરો." },
    { id: 7, english: "Do not play Holi.", hindi: "होली न खेलें।", guj: "હોળી ન રમો." },
    { id: 8, english: "Do not splash water for fun.", hindi: "मस्ती-मज़ाक के लिए पानी बर्बाद ना करें।", guj: "મસ્તી-મજાક માટે પાણીનો બગાડ ન કરો." },
    { id: 9, english: "Take only as much water as you can drink.", hindi: "जितनी जरूरत हो, उतना ही पानी पीने के लिए लें।", guj: "જરૂર હોય તેટલું જ પાણી પીવા માટે લો." },
    ...
    { id: 11, english: "Use a bucket instead of flush.", hindi: "फ्लश के बदले बाल्टी का इस्तेमाल करें।", guj: "ફ્લશને બદલે ડોલનો ઉપયોગ કરો." },
    { id: 12, english: "Avoid going to swimming pools.", hindi: "स्विमिंग पूल जाने से बचें।", guj: "સ્વિમિંગ પૂલમાં જવાનું ટાળો." },
    { id: 13, english: "Fix a leaky tap.", hindi: "टपकते नलों को ठीक करवाएँ।", guj: "નળમાં લીકેજ હોય તો તેને રિપેર કરાવો." },
  ],

  3: [
    { id: 1, english: "Bhagwan Mahavir preached that water has life and we should save lives.", hindi: "भगवान महावीर ने कहा है कि जल में जीव है और हमें जीवों की रक्षा करनी चाहिए।", guj: "ભગવાન મહાવીરે કહ્યું કે, પાણીમાં જીવ છે અને આપણે તે જીવોની રક્ષા કરવી જોઈએ." },
    ...
    { id: 5, english: "Only 3% of the total water on Earth is fresh water.", hindi: "पृथ्वी पर उपलब्ध कुल पानी में से केवल ३% पानी मीठा(स्वच्छ) पानी है।", guj: "પૃથ્વી પર ઉપલબ્ધ કુલ પાણીમાંથી માત્ર 3% પાણી જ મીઠું(શુદ્ધ) પાણી છે " },
    ...
    { id: 8, english: "“If there is water, there is a future.”", hindi: "“जल है तो कल है”", guj: "“જો પાણી છે, તો ભવિષ્ય છે.”" },
  ],
};
